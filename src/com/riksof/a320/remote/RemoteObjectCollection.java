...
/**
 * This is the class where asynchronous task are performed User has to override
 * the doInBackground method where user will call the getRemoteObject method
 ...
 * @param <T>
 */
public abstract class RemoteObjectCollection<T extends RemoteObject> extends
